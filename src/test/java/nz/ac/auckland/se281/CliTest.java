...
public abstract class CliTest {
  ...
  /**
   * To be overridden by subclasses to reset things (e.g., any static variables that may be used).
   */
  public void reset() {}
  ...
  public void runCommands(Object... commands)
    ...
    Object main =
        mainClass
            .getConstructor(Scanner.class, OperatorManagementSystem.class)
            .newInstance(new Scanner(sb.toString()), new OperatorManagementSystem());
